...
class TextoAutoDesplazable extends StatefulWidget {
  const TextoAutoDesplazable(
    this.text, {
    super.key,
    this.style,
  ...
  @override
  State<TextoAutoDesplazable> createState() => _TextoAutoDesplazableState();
}

class _TextoAutoDesplazableState extends State<TextoAutoDesplazable>
