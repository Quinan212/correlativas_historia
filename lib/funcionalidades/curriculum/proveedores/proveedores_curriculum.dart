...
const _procesosamericanos1 = {
  ...
  'bibliografia': [
    ...
    'VIVES, V. (1979). Historia Social y económica de España y América. Barcelona: VicensVives.',
  ],
};
...
const _economiapolitica = {
  ...
  'bibliografia': [
    ...
    'TOUCHARD, J. (2000). Historia de las ideas políticas. Madrid: Tecnos.',
    'VAZQUEZ PRESEDO, V. (1996). Globalización, Integración, Argentina, Brasil. Buenos Aires: Academia Nacional de Ciencias Económicas.',
  ],
};
...
const _didacticacienciassociales = {
  ...
  'bibliografia': [
    ...
    'ZELMANOVICH, P.; GONZÁLEZ y otros (2006). Efemérides, entre el mito y la Historia. Argentina: Paidós.',
  ],
};
