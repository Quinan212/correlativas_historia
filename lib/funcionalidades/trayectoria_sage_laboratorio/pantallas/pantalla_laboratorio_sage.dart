...
class _PantallaLaboratorioSageState extends State<PantallaLaboratorioSage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget content = _planVisible
        ? PantallaPlanSageLaboratorio(
            key: const ValueKey('sage-lab-plan'),
            trajectoryListenable: _trajectory,
            localLoadedListenable: _localLoaded,
          )
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                _BotonSincronizarInicioLaboratorio(
...
class PantallaPlanSageLaboratorio extends StatefulWidget {
  const PantallaPlanSageLaboratorio({
    super.key,
    required this.trajectoryListenable,
    required this.localLoadedListenable,
  });
  ...
  @override
  State<PantallaPlanSageLaboratorio> createState() =>
      _PantallaPlanSageLaboratorioState();
}

class _PantallaPlanSageLaboratorioState
    extends State<PantallaPlanSageLaboratorio> {
  int _careerIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Plan desde SAGE'),
        actions: const [
          Padding(
            padding: EdgeInsets.only(right: 14),
            child: Center(child: _BadgePruebas()),
          ),
        ],
      ),
        ...
        builder: (context, loaded, _) {
          ...
          return ValueListenableBuilder<TrayectoriaSageLaboratorio?>(
            ...
            builder: (context, trajectory, _) {
              ...
              for (final subjects in grouped.values) {
                subjects.sort(
                ...
                children: [
                  if (trajectory.carreras.length > 1)
                    DropdownButtonFormField<int>(
                      key: ValueKey<String>(
                        'plan-carrera-$safeIndex-${trajectory.sincronizadaEn?.millisecondsSinceEpoch ?? 0}',
                      ),
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          '${career.materias.length} materias',
                  ...
                  if (years.isEmpty)
                    const _EstadoVacioSeccionLaboratorio(
                      ...
                      title: 'SAGE no informó materias',
                      compact: true,
                    )
                  else
                    for (final year in years) ...[
                      Row(
                        children: [
                          ...
                          Text(
                            year == null ? 'Sin año informado' : '$year° año',
                      ...
                      LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          return Wrap(
                            ...
                            runSpacing: 10,
                            children: [
                              for (final subject in grouped[year]!)
                                SizedBox(
                                  width: cardWidth,
                                  child: _TarjetaMateriaSage(subject: subject),
                                ),
                            ],
                          );
                        },
...
class _BotonSincronizarInicioLaboratorio extends StatelessWidget {
  const _BotonSincronizarInicioLaboratorio({
  ...
  @override
  Widget build(BuildContext context) {
    final canSync = draft?.listaParaSincronizar == true && !saving;
    final scheme = Theme.of(context).colorScheme;
    return Column(
      ...
      children: [
        FilledButton.tonalIcon(
          ...
          label: Text(saving ? 'Sincronizando…' : 'Sincronizar'),
