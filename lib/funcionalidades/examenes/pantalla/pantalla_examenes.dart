                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<String>(
                                  ...
                                  onChanged: (v) {
                                    ...
                                    ref
                                        .read(
                                          proveedorIdCarreraExamenes.notifier,
                                        )
                                        .state = v;
                                  },
                                ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...examCareerOptions.map(
                    (career) => _BotonCarreraEscritorio(
                      career: career,
                      selected: career.id == careerId,
                      onTap: () {
                        setState(() {
                        ...
                        ref.read(proveedorIdCarreraExamenes.notifier).state =
                            career.id;
                      },
                    ),
                  ),
                  ...
                  const Spacer(),
                  _NotaLateralEscritorio(isDark: isDark),
                ],
              ),
            ),
          ),
...
class _CampoBusquedaEscritorio extends StatelessWidget {
  const _CampoBusquedaEscritorio({
...
class _BotonCarreraEscritorio extends StatelessWidget {
  const _BotonCarreraEscritorio({
...
class _BotonAlcanceEscritorio extends StatelessWidget {
  const _BotonAlcanceEscritorio({
    required this.label,
    required this.icon,
    required this.selected,
    required this.onTap,
...
class _BotonAnioEscritorio extends StatelessWidget {
  const _BotonAnioEscritorio({
    required this.label,
    required this.selected,
    required this.onTap,
  });
...
class _NotaLateralEscritorio extends StatelessWidget {
  const _NotaLateralEscritorio({required this.isDark});
...
class _ResumenEscritorio extends StatelessWidget {
  const _ResumenEscritorio({
...
class _EstadoVacioEscritorio extends StatelessWidget {
  const _EstadoVacioEscritorio({required this.message});
