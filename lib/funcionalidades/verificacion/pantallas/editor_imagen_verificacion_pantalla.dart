...
class EditorImagenVerificacionPantalla extends StatefulWidget {
  const EditorImagenVerificacionPantalla({
    super.key,
  ...
  @override
  State<EditorImagenVerificacionPantalla> createState() =>
      _EditorImagenVerificacionPantallaState();
}

class _EditorImagenVerificacionPantallaState
    extends State<EditorImagenVerificacionPantalla> {
  ...
  Widget build(BuildContext context) {
    ...
    final showExpandButton =
        originalRatio != null && (originalRatio - _defaultRatio).abs() > 0.05;
                    ...
                    children: [
                      ...
                      Crop(
                        ...
                        overlayBuilder: (context, rect) =>
                            const _CapaMarcoLimpio(),
                        onCropped: (result) {
                          if (!mounted) return;
                          switch (result) {
                            case CropSuccess(:final croppedImage):
                              Navigator.of(context).pop(
                                ImagenSubidaVerificacion(
                                  bytes: croppedImage,
...
class _CapaMarcoLimpio extends StatelessWidget {
  const _CapaMarcoLimpio();
