...
class RepositorioLimpiezaMasivaAdministrador {
  const RepositorioLimpiezaMasivaAdministrador();

  Future<ResultadoLimpiezaMasivaAdministrador> runAction({
    ...
    return ResultadoLimpiezaMasivaAdministrador(summary: summary);
  }
}
