...
class NavegacionMateriaAdministradorPantalla extends ConsumerWidget {
  const NavegacionMateriaAdministradorPantalla({super.key});
          ...
          child: ConstrainedBox(
            ...
            child: overviewAsync.when(
              data: (overview) {
                ...
                if (isDesktop) {
                  return _NavegacionMateriaAdminEscritorio(
                    overview: overview,
...
class _NavegacionMateriaAdminEscritorio extends StatelessWidget {
  const _NavegacionMateriaAdminEscritorio({
  ...
  final ResumenNavegacionMateriaAdministrador overview;
  ...
  final List<EventoNavegacionMateriaAdministrador> viewEvents;
...
class _UserTile extends StatelessWidget {
  ...
  final ResumenDispositivoNavegacionMateriaAdministrador device;
