...
class ActividadAdministradorPantalla extends ConsumerWidget {
  const ActividadAdministradorPantalla({super.key});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () =>
                ref.invalidate(proveedorDispositivosObservadosAdministrador),
            ...
            child: observedDevicesAsync.when(
              data: (items) {
                ...
                return ListView(
                  ...
                  children: [
                    _EstadisticasEncabezado(totalDevices: items.length),
...
class _EstadisticasEncabezado extends StatelessWidget {
  const _EstadisticasEncabezado({required this.totalDevices});
...
class _TarjetaDispositivoObservado extends StatelessWidget {
  const _TarjetaDispositivoObservado({required this.device});
  final DispositivoObservadoAdministrador device;
...
String _normalizarEtiquetaDispositivo(String label) {
