...
final proveedorFiltroCarreraEstudiantesAdministrador = StateProvider<String>(
  (_) => 'artes_visuales',
);
...
final proveedorMateriasEstudianteAdministrador =
    FutureProvider.family<
      List<MateriaEstudianteAdministrador>,
      ({String adminDeviceId, String studentId})
    >((ref, args) async {
      final client = ref.watch(proveedorClienteSupabase);
...
final proveedorNominaMateriaAdministrador =
    FutureProvider.family<
      List<ItemNominaMateriaAdministrador>,
      ({String adminDeviceId, String careerId, String subjectId})
    >((ref, args) async {
      final client = ref.watch(proveedorClienteSupabase);
...
final proveedorHistorialEstudianteAdministrador =
    FutureProvider.family<
