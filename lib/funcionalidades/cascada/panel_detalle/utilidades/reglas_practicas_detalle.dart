...
List<(String, String)> mergePd3(
    List<CorrelativaDetallada> det, List<(String, String)> overrides) {
  final order = <String>[];
...
String etiquetaEstado(String type) =>
    type == 'A' ? '(APROBADA)' : '(REGULARIZADA)';

List<Materia> dependientesDeMateria(
    List<Materia> all, Materia base, String careerId) {
