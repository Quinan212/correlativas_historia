...
Future<void> showInstitutionSelectionOverlay(
  ...
  OverlayEntry? entry;
  entry = OverlayEntry(
    builder: (overlayContext) => _CapaSeleccionInstitucion(
...
class _CapaSeleccionInstitucion extends StatefulWidget {
  const _CapaSeleccionInstitucion({
  ...
  @override
  State<_CapaSeleccionInstitucion> createState() =>
      _CapaSeleccionInstitucionState();
}

class _CapaSeleccionInstitucionState extends State<_CapaSeleccionInstitucion>
            ...
            Positioned(
              ...
              child: AnimatedBuilder(
                ...
                child: RepaintBoundary(
                  child: Center(
                    child: _TarjetaSeleccionPremium(
                      width: cardWidth,
                      height: cardHeight,
                      useBanner: useBanner,
...
class _TarjetaSeleccionPremium extends StatelessWidget {
  const _TarjetaSeleccionPremium({
    required this.width,
...
class _CheckExitoAnimado extends StatelessWidget {
  const _CheckExitoAnimado({
...
class _ArteInstitucionAnimado extends StatefulWidget {
  const _ArteInstitucionAnimado({
  ...
  @override
  State<_ArteInstitucionAnimado> createState() =>
      _ArteInstitucionAnimadoState();
}

class _ArteInstitucionAnimadoState extends State<_ArteInstitucionAnimado> {
  ...
  @override
  void didUpdateWidget(covariant _ArteInstitucionAnimado oldWidget) {
