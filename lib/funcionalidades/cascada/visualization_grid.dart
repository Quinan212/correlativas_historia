...
String _etiquetaCuatri(int? cuatri) {
...
class GrillaVisualizacion extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GrillaVisualizacion> createState() => _GrillaVisualizacionState();
}

class _GrillaVisualizacionState extends ConsumerState<GrillaVisualizacion> {
  @override
  Widget build(BuildContext context) {
    final zoom = ref.watch(proveedorZoom);
    final materias = ref.watch(proveedorMateriasFiltradas);
                        ...
                        children: () {
                          ...
                          for (final m in yearMaterias) {
                            if (m.cuatri != lastCuatri) {
                              final label = _etiquetaCuatri(m.cuatri);
                              children.add(
                                Padding(
...
class _TarjetaMateria extends ConsumerWidget {
  final Materia m;
  final bool borderless;

  const _TarjetaMateria(this.m, {this.borderless = false});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final selectedId = ref.watch(proveedorIdMateriaSeleccionada);
                  ...
                  child: ClipRRect(
                    ...
                    child: Material(
                      ...
                      child: ListView(
                        ...
                        children: const [
                          RepaintBoundary(child: PanelDetalleMateria()),
                        ],
                      ),
                    ),
                  ),
