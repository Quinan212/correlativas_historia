...
String _etiquetaTipoCarrera(_CareerType t) {
  switch (t) {
...
class PantallaMapaCorrelatividades extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isWindowsDesktop = _esWindowsEscritorio();
      ...
      body: CustomScrollView(
        slivers: [
          SliverPersistentHeader(
            pinned: true,
            floating: false,
            delegate: _DelegadoBannerColapsable(topInset: topInset),
          ),
          SliverToBoxAdapter(
                  ...
                  children: [
                    if (isDesktop && isWindowsDesktop) ...[
                      const Row(
                        ...
                        children: [
                          Expanded(child: _ContenedorEncabezadoHero()),
                          SizedBox(width: 12),
                          Expanded(child: _ContenedorTarjetaRegimen()),
                        ],
                      ),
                      ...
                      const _ContenedorEncabezadoHero(),
                      const SizedBox(height: 12),
                      if (isDesktop) ...[
                        const Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Expanded(child: _ContenedorTarjetaRegimen()),
                            SizedBox(width: 12),
                            Expanded(child: _TarjetaSelectorCarreraIndependiente()),
                          ],
                        ),
                        const SizedBox(height: 12),
                        const FiltersBar(),
                      ] else ...[
                        const _ContenedorTarjetaRegimen(),
                        const SizedBox(height: 12),
                        const _TarjetaSelectorCarreraIndependiente(),
                        const SizedBox(height: 12),
                        const FiltersBar(),
                      ],
                    ],
                    const SizedBox(height: 12),
                    if (!isDesktop) const GrillaVisualizacion(),
                  ],
                ),
              ),
            ),
  ...
  Widget _regimenCard(BuildContext context, WidgetRef ref) {
    ...
    final career = ref.watch(proveedorCarreraSeleccionada);
...
class _ContenedorEncabezadoHero extends StatelessWidget {
  const _ContenedorEncabezadoHero();

  @override
  Widget build(BuildContext context) =>
      const PantallaMapaCorrelatividades()._heroHeader(context);
}

class _ContenedorTarjetaRegimen extends ConsumerWidget {
  const _ContenedorTarjetaRegimen();

  @override
  Widget build(BuildContext context, WidgetRef ref) =>
      const PantallaMapaCorrelatividades()._regimenCard(context, ref);
}
...
class _BarraControlesUnaLineaState extends ConsumerState<_OneLineControlsBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final currentC = ref.watch(proveedorCarreraSeleccionada);
    final searchVal = ref.watch(proveedorTerminoBusqueda);
              ...
              children: [
                ...
                DropdownButtonFormField<_CareerType?>(
                  ...
                  items: availableTypes
                      ...
                      value: t,
                      child: Text(_etiquetaTipoCarrera(t)),
                    ),
                  )
                      .toList(),
                  onChanged: (value) {
              ...
              children: [
                ...
                DropdownButtonFormField<String?>(
                  ...
                  onChanged: _selectedType == null
                    ...
                    ref
                        .read(
                        proveedorIdCarreraSeleccionada.notifier)
                        .state = v;
                    ref
                        .read(proveedorTerminoBusqueda.notifier)
                        .state = '';
                    ref
                    ...
                    ref
                        ...
                        .state = null;
                    ref
                        .read(proveedorZoom.notifier)
                        .state = 1.0;
                    final tc = ref.read(
                        proveedorControladorTransformacion);
...
class _TarjetaSelectorCarreraIndependiente extends ConsumerStatefulWidget {
  const _TarjetaSelectorCarreraIndependiente({super.key});

  @override
  ConsumerState<_TarjetaSelectorCarreraIndependiente> createState() =>
      _TarjetaSelectorCarreraIndependienteState();
}

class _TarjetaSelectorCarreraIndependienteState
    extends ConsumerState<_TarjetaSelectorCarreraIndependiente> {
  _CareerType? _selectedType;
  ...
  Widget build(BuildContext context) {
    ...
    InputDecoration inputDecoration({String? hint}) =>
        PantallaMapaCorrelatividades._inputDecoration(context, hint: hint);
        ...
        children: [
          ...
          DropdownButtonFormField<String?>(
            ...
            onChanged: _selectedType == null
              ...
              if (v == null || v == currentC.id) return;
              ref
                  .read(proveedorIdCarreraSeleccionada.notifier)
                  .state = v;
              ref
                  .read(proveedorTerminoBusqueda.notifier)
                  .state = '';
              ...
              ref
                  ...
                  .state = null;
              ref
                  .read(proveedorIdMateriaSeleccionada.notifier)
                  .state = null;
              ref.read(proveedorZoom.notifier).state = 1.0;
              final tc =
              ref.read(proveedorControladorTransformacion);
              tc.value = Matrix4.identity();
            },
          ),
        ],
...
class _TableroAniosEscritorio extends StatelessWidget {
  const _TableroAniosEscritorio();
...
class CarrilAnio extends ConsumerWidget {
  const CarrilAnio({super.key, required this.year});
  final int year;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ProviderScope(
      ...
      child: const GrillaVisualizacion(
...
class _DelegadoBannerColapsable extends SliverPersistentHeaderDelegate {
  _DelegadoBannerColapsable({required this.topInset});
  ...
  @override
  bool shouldRebuild(covariant _DelegadoBannerColapsable oldDelegate) {
