...
class _DetalleMateriaPageState extends ConsumerState<_DetalleMateriaPage> {
  ...
  void initState() {
    ...
    _detailOpenTrace = RendimientoApp.iniciarTraza(
      'detail_sheet_open',
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await RendimientoApp.detenerTraza(await _detailOpenTrace);
    });
  }
  ...
  Future<void> _trackTransition({
    ...
    await _analytics.trackTransition(
      client: client,
      deviceId: deviceId,
      sourceCareerId: ref.read(proveedorCarreraSeleccionada).id,
      sourceMatterId: source.id,
      sourceMatterName: source.nombre,
      targetCareerId: ref.read(proveedorCarreraSeleccionada).id,
