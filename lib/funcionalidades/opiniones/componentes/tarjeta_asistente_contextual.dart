...
class TarjetaAsistenteContextual extends ConsumerStatefulWidget {
  const TarjetaAsistenteContextual({
    super.key,
  ...
  @override
  ConsumerState<TarjetaAsistenteContextual> createState() =>
      _TarjetaAsistenteContextualState();
}

class _TarjetaAsistenteContextualState
    extends ConsumerState<TarjetaAsistenteContextual> {
  final TextEditingController _controller = TextEditingController();
  bool _loading = false;
  RespuestaAsistenteContextual? _response;
  String? _error;
  ...
  Widget build(BuildContext context) {
    ...
    final isAvailable = ref.watch(proveedorClienteSupabase) != null;
      ...
      child: Column(
        ...
        children: [
          ...
          if (_response != null) ...[
            ...
            _VistaRespuestaAsistente(response: _response!),
          ],
        ],
      ),
    );
...
class _VistaRespuestaAsistente extends StatelessWidget {
  const _VistaRespuestaAsistente({required this.response});

  final RespuestaAsistenteContextual response;
