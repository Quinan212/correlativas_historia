...
class AdminExamNavigationUserScreen extends ConsumerWidget {
  const AdminExamNavigationUserScreen({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final events = ref.watch(adminExamNavigationEventsByDeviceProvider(deviceId));
...
class _SummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final distinctMatters = events.where((e) => e.isView).map((e) => e.matterName).toSet().length;
    ...
    return Container(
      ...
      child: Wrap(
        ...
        children: [
          ...
          _Metric(label: 'Materias unicas', value: '$distinctMatters'),
        ],
      ),
    );
  }
...
class _TimelineTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final divText = event.divisionLabel == null ? '' : ' - ${event.divisionLabel}';
