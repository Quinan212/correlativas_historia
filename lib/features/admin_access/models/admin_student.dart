class AdminStudent {
  ...
  factory AdminStudent.fromRow(Map<String, dynamic> row) {
    ...
    return AdminStudent(
      ...
      initialPassword:
          (row['initial_password'] ?? AdminStudentDraft.defaultPassword)
              .toString(),
...
class AdminStudentDraft {
  const AdminStudentDraft({
    this.id,
    required this.dni,
    required this.firstName,
    required this.lastName,
