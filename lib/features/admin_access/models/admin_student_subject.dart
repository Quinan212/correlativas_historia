class AdminStudentSubject {
  const AdminStudentSubject({
    this.id,
  ...
  factory AdminStudentSubject.fromRow(Map<String, dynamic> row) {
...
class AdminStudentSubjectDraft {
  const AdminStudentSubjectDraft({
    this.id,
    required this.studentId,
    required this.careerId,
    required this.subjectId,
