class StudentAccessProfile {
  ...
  factory StudentAccessProfile.fromJson(Map<String, dynamic> json) {
...
class StudentAccessSubject {
  const StudentAccessSubject({
  ...
  factory StudentAccessSubject.fromJson(Map<String, dynamic> json) {
    int? parseInt(dynamic value) {
      if (value == null) return null;
      if (value is num) return value.toInt();
      return int.tryParse(value.toString());
...
class StudentAccessHistoryEntry {
  const StudentAccessHistoryEntry({
  ...
  factory StudentAccessHistoryEntry.fromJson(Map<String, dynamic> json) {
    return StudentAccessHistoryEntry(
...
class StudentAccessPayload {
  const StudentAccessPayload({
  ...
  final List<StudentAccessSubject> selfSubjects;

  List<StudentAccessSubject> get combinedSubjects {
  ...
  factory StudentAccessPayload.fromJson(Map<String, dynamic> json) {
    return StudentAccessPayload(
      student: StudentAccessProfile.fromJson(
        (json['student'] as Map).cast<String, dynamic>(),
      ),
      subjects: (json['subjects'] as List? ?? const [])
          .whereType<Map>()
          .map((row) => StudentAccessSubject.fromJson(
                row.cast<String, dynamic>(),
              ))
          .toList(growable: false),
      history: (json['history'] as List? ?? const [])
          .whereType<Map>()
          .map((row) => StudentAccessHistoryEntry.fromJson(
                row.cast<String, dynamic>(),
              ))
          .toList(growable: false),
