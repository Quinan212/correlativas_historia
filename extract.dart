...
void main() {
  final html = File('assets/Artes_visuales.html').readAsStringSync();
  final jsArray = _extractMateriasArray(html);
  if (jsArray == null) {
    stdout.writeln('Failed to extract array');
    return;
  }
  ...
  File('assets/data/artes_visuales.json').writeAsStringSync(jsonEncode(finalJson));
  stdout.writeln('Done parsing Artes_visuales.html -> artes_visuales.json');
}
