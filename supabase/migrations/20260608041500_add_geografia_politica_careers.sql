-- Agregar 'geografia' y 'politica' a los constraints CHECK de career_id en academic_students
...
alter table public.academic_students
  add constraint academic_students_career_id_check
    check (career_id in ('artes_visuales', 'musica', 'historia', 'geografia', 'politica'));

-- Agregar 'geografia' y 'politica' a los constraints CHECK de career_id en academic_student_subjects
