...
('historia', null, '2026-05-11', '18:30', 'Práctica Docente I', 'coloquio', ARRAY['OCHOA, Natalia', 'MARTINEZ, Gustavo']::text[]),
('historia', null, '2026-05-11', '18:30', 'Práctica Docente I', 'coloquio', ARRAY['OCHOA, Natalia', 'MARTINEZ, Gustavo']::text[]),
('historia', null, '2026-05-11', '18:30', 'Didáctica de las Ciencias Sociales', 'coloquio', ARRAY['CODURI, Emilia']::text[]),
('historia', null, '2026-05-11', '18:30', 'Didáctica de las Ciencias Sociales', 'coloquio', ARRAY['PALAVECINI, Patricia']::text[]),
('historia', null, '2026-05-12', '18:30', 'Práctica Docente II', 'coloquio', ARRAY['ROBINSON, Soledad', 'GONZALEZ, Carlos']::text[]),
('historia', null, '2026-05-12', '18:30', 'Práctica Docente II', 'coloquio', ARRAY['ROBINSON, Soledad', 'GONZALEZ, Carlos']::text[]),
('historia', null, '2026-05-14', '18:30', 'Epistemología de la Historia', 'coloquio', ARRAY['BORCHE, Javier']::text[]),
('historia', null, '2026-05-14', '18:30', 'Epistemología de la Historia', 'coloquio', ARRAY['BORCHE, Javier']::text[]),
('historia', null, '2026-05-15', '18:30', 'Práctica Docente III', 'coloquio', ARRAY['LOWER, Griselda', 'CODURI, Emilia']::text[]),
('geografia', null, '2026-05-15', '18:30', 'Práctica Docente III', 'coloquio', ARRAY['LOWER, Griselda', 'CODURI, Emilia']::text[]),
('geografia', null, '2026-05-15', '18:30', 'Práctica Docente III', 'coloquio', ARRAY['LOWER, Griselda', 'CODURI, Emilia']::text[]),
('politica', null, '2026-05-15', '18:30', 'Práctica Docente II', 'coloquio', ARRAY['LOWER, Griselda', 'CODURI, Emilia']::text[]),
('politica', null, '2026-05-15', '18:30', 'Didáctica de las Ciencias Sociales', 'coloquio', ARRAY['LOWER, Griselda', 'CODURI, Emilia']::text[]),
('politica', null, '2026-05-15', '18:30', 'Práctica Docente III', 'coloquio', ARRAY['LOWER, Griselda', 'CODURI, Emilia']::text[])
;
